...
if minetest.setting_getbool("lib_clouds_generation") == true then
	...
	minetest.register_ore({
		...
		clust_num_ores = 64,
		clust_size = 3,
		y_min = water_level + minetest.setting_getbool("lib_clouds_cirrus_miny"),
		y_max = water_level + minetest.setting_getbool("lib_clouds_cirrus_maxy"),
		flags = "",
		noise_threshold = 0.5,
	...
	minetest.register_ore({
		...
		clust_num_ores = 6,
		clust_size = 3,
		y_min = water_level + minetest.setting_getbool("lib_clouds_cumulus_miny"),
		y_max = water_level + minetest.setting_getbool("lib_clouds_cumulus_maxy"),
		flags = "",
		noise_threshold = 0.5,
		noise_params = {offset=0, scale=1, spread={x=100, y=100, z=100}, seed=23, octaves=3, persist=0.70},
				--  ^ NoiseParams structure describing the perlin noise used for ore distribution.
	...
	minetest.register_ore({
		...
		clust_num_ores = 8,
		clust_size = 3,
		y_min = water_level + minetest.setting_getbool("lib_clouds_fog_miny"),
		y_max = water_level + minetest.setting_getbool("lib_clouds_fog_maxy"),
		flags = "",
		noise_threshold = 0.5,
		noise_params = {offset=0, scale=1, spread={x=100, y=100, z=100}, seed=23, octaves=3, persist=0.70},
				--  ^ NoiseParams structure describing the perlin noise used for ore distribution.
