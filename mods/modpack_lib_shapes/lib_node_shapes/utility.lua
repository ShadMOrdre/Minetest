function lib_node_shapes.get(pos)
	local node_name = minetest.get_node(pos).name
	if lib_node_shapes.registered_doors[node_name] then
		...
		return {
			...
			open = function(self, player)
				...
				return lib_node_shapes.door_toggle(self.pos, nil, player)
			end,
...
function lib_node_shapes.door_toggle(pos, node, clicker)
...
function lib_node_shapes.sit(pos, node, clicker, pointed_thing)
...
function lib_node_shapes.sit_dig(pos, player)
...
function lib_node_shapes.get_node_group(name, group)
...
function lib_node_shapes.get_nodedef_field(nodename, fieldname)
...
function lib_node_shapes.get_item_groups(name, groups)
