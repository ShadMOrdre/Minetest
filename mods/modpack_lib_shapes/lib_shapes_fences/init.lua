...
lib_node_shapes.register_shape("fence", {
	description = "Fence", 
...
lib_node_shapes.register_shape("railing", {
	description = "Railing", 
	shape_type = "connected",
	node_box = {
		type = "connected",
		...
		connect_front = {
			{-0.0625, 0.25, -0.5, 0.0625, 0.5, -0.0625},
		},
		connect_back = {
			{-0.0625, 0.25, 0.0625, 0.0625, 0.5, 0.5},
		},
		connect_left = {
			{-0.5, 0.25, -0.0625, -0.0625, 0.5, 0.0625},
		},
		connect_right = {
			{0.0625, 0.25, -0.0625, 0.5, 0.5, 0.0625},
		},
	},
	selection_box = {
		type = "fixed",
